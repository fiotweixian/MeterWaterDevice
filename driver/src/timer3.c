...
en_result_t Tim3_Mode23_DeInit(stc_tim3_mode23_cfg_t* pstcCfg)
{
    en_result_t enResult = Ok;
  
		//0x0060 0008
		M0P_TIM3_MODE23->M23CR_f.CTEN = 0u;
		M0P_TIM3_MODE23->M23CR_f.CIS  = 0u;
		M0P_TIM3_MODE23->M23CR_f.CT = 0u;
		M0P_TIM3_MODE23->M23CR_f.PWM2S = 1u;	
		M0P_TIM3_MODE23->M23CR_f.PRS = 0u;
		M0P_TIM3_MODE23->M23CR_f.BUFPEN = 0u;
		M0P_TIM3_MODE23->M23CR_f.CRG = 0u;
		M0P_TIM3_MODE23->M23CR_f.CFG = 0u;
		M0P_TIM3_MODE23->M23CR_f.UIE = 0u;
		M0P_TIM3_MODE23->M23CR_f.MODE = 0u;
		M0P_TIM3_MODE23->M23CR_f.ONESHOT = 0u;
		M0P_TIM3_MODE23->M23CR_f.CSG = 0u;
		M0P_TIM3_MODE23->M23CR_f.OCCS = 0u;
		M0P_TIM3_MODE23->M23CR_f.URS = 0u;
		M0P_TIM3_MODE23->M23CR_f.TDE = 0u;
		M0P_TIM3_MODE23->M23CR_f.TIE = 0u;//19
		M0P_TIM3_MODE23->M23CR_f.BIE = 0;
		M0P_TIM3_MODE23->M23CR_f.CIS = 0x3u;
		M0P_TIM3_MODE23->M23CR_f.OCCE = 0u;
		M0P_TIM3_MODE23->M23CR_f.TG = 0u;
		M0P_TIM3_MODE23->M23CR_f.UG = 0u;
		M0P_TIM3_MODE23->M23CR_f.BG = 0u;		
		M0P_TIM3_MODE23->M23CR_f.DIR = 0u;		

		M0P_TIM3_MODE23->CRCH0_f.CSA         = 0u;
		M0P_TIM3_MODE23->FLTR_f.OCMA0_FLTA0  = 0u;
		M0P_TIM3_MODE23->FLTR_f.CCPA0        = 0u;
		M0P_TIM3_MODE23->CRCH0_f.BUFEA       = 0u;
		M0P_TIM3_MODE23->M23CR_f.CIS         = 0x3;

		M0P_TIM3_MODE23->CRCH0_f.CSB         = 0u;
		M0P_TIM3_MODE23->FLTR_f.OCMB0_FLTB0  = 0u;
		M0P_TIM3_MODE23->FLTR_f.CCPB0        = 0u;
		M0P_TIM3_MODE23->CRCH0_f.BUFEB       = 0u;
		M0P_TIM3_MODE23->CRCH0_f.CISB        = 0x3;
