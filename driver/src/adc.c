...
void Adc_DeInit(void)
{
    ...
    EnableNvic(ADC_DAC_IRQn, IrqLevel3, FALSE);
		...
		//0x0000 6 7 F 0
    M0P_ADC->CR0_f.IE = 0u;//15		
	M0P_ADC->CR0_f.INREFEN = 1u;//14
    M0P_ADC->CR0_f.SAM = 0x2u;//13-12
    M0P_ADC->CR0_f.BUF = 0u;//11		
	M0P_ADC->CR0_f.REF = 0x3u;//10-9	
	M0P_ADC->CR0_f.SGLMUX = 0x1f;//8-4
    M0P_ADC->CR0_f.CLKDIV = 0u;//3:2		
	M0P_ADC->CR0_f.EN = 0u;//0	
    ...
    M0P_ADC->CR1_f.RACCEN = 0u;
    M0P_ADC->CR1_f.MODE = 0u;
    M0P_ADC->CR1_f.DMAJQR = 0u;
    M0P_ADC->CR1_f.DMASQR = 0u;
    M0P_ADC->CR1_f.THCH = 0u;
    M0P_ADC->CR1_f.ALIGN = 0u;
	
	
	M0P_ADC->SQR0_f.CH0MUX = 0;
	M0P_ADC->SQR0_f.CH1MUX = 0;
	M0P_ADC->SQR0_f.CH2MUX = 0;
	M0P_ADC->SQR0_f.CH3MUX = 0;
	M0P_ADC->SQR0_f.CH4MUX = 0;
	M0P_ADC->SQR0_f.CH5MUX = 0;		

	M0P_ADC->SQR1_f.CH6MUX = 0;
	M0P_ADC->SQR1_f.CH7MUX = 0;
	M0P_ADC->SQR1_f.CH8MUX = 0;
	M0P_ADC->SQR1_f.CH9MUX = 0;
	M0P_ADC->SQR1_f.CH10MUX = 0;
	M0P_ADC->SQR1_f.CH11MUX = 0;	
	
	M0P_ADC->SQR2_f.CH12MUX = 0;
	M0P_ADC->SQR2_f.CH13MUX = 0;
	M0P_ADC->SQR2_f.CH14MUX = 0;
	M0P_ADC->SQR2_f.CH15MUX = 0;
	M0P_ADC->SQR2_f.CNT = 0;
		
	M0P_ADC->RESULT = 0;
	
	//0x0000 0 0 3 F
    M0P_ADC->ICR_f.JQRIC = 1u;	
    M0P_ADC->ICR_f.SQRIC = 1u;	
    M0P_ADC->ICR_f.REGIC = 1u;
    M0P_ADC->ICR_f.HTIC = 1u;
    M0P_ADC->ICR_f.LTIC = 1u;
    M0P_ADC->ICR_f.SGLIC = 1u;
	
		
	M0P_ADC->EXTTRIGGER0 = 0u;
	M0P_ADC->EXTTRIGGER1 = 0u;
